...
#include <Eigen/Dense>  // Added for Eigen types
#include <rclcpp/rclcpp.hpp>

#include <pcl/common/io.h>  // Added for pcl::getFieldIndex
...
// Remove the old set_x_filter_threshold implementation and add new ROI setter.
